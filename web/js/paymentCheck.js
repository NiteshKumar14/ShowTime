...
function checkPayment(e){
    ...
    else if( !cardnumber.value.match(/[0-9]{16,19}/) ){ cardnumber.style.borderColor="#FF0000";  e.preventDefault();}
    else if(!expiry_month.value) {expiry_month.style.borderColor="#FF0000";  e.preventDefault();}
    else if(!expiry_year.value) { expiry_year.style.borderColor="#FF0000";  e.preventDefault();}
    else if(!cvv.value){ cvv.style.borderColor="#FF0000"; e.preventDefault();}
}
